...
// ✅ Create transporter with Gmail account (hardcoded credentials)
let transporterPromise = Promise.resolve(
  nodemailer.createTransport({
    host: "smtp.gmail.com",
    port: 587,
    secure: false,         // false = STARTTLS (TLS on port 587)
    requireTLS: true,      // 👈 Force TLS
    auth: {
      user: "info@bayareacabinetry.us",       // Workspace email
      pass: "rmfmuvcorkqtkqsl",               // Gmail App Password (no spaces!)
    },
  })
);
